...
class UpdateMetricsThread(threading.Thread):
    ...
    @staticmethod
    def _get_ps_output():
        # /bin/ps -C rsession o rss,etimes --no-headers
        try:
            output = subprocess.check_output(['/bin/ps', '-C', 'rsession', 'o', 'rss,etimes', '--no-headers'])
        except:
            output = ''
...
def metric_init(params):
    ...
    descriptors = [
        ...
        'slope': 'both',
        'format': '%d',
        'description': 'Count of rsession processes',
        'groups': 'rstudio,questanalytics'},
        ...
        'slope': 'both',
        'format': '%.2f',
        'description': 'Total memory resident set size of rsession processes',
        'groups': 'rstudio,questanalytics'},
        ...
        'slope': 'both',
        'format': '%.2f',
        'description': 'Average memory resident set size of rsession processes',
        'groups': 'rstudio,questanalytics'},
        ...
        'slope': 'both',
        'format': '%.2f',
        'description': 'Max memory resident set size of a single rsession process',
        'groups': 'rstudio,questanalytics'},
        ...
        'slope': 'both',
        'format': '%.2f',
        'description': 'Average session length of rsession processes',
        'groups': 'rstudio,questanalytics'},
        ...
        'slope': 'both',
        'format': '%.2f',
        'description': 'Max session length of a single rsession process',
        'groups': 'rstudio,questanalytics'},
    ]
